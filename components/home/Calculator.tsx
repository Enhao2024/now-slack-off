...
function Calculator({ title }: Props) {
    ...
    <div className="mx-4 flex flex-col justify-center items-center space-y-8">
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <input
          ...
          className="input input-bordered w-full max-w-xs no-spin w-32"
          onChange={(e) => {
      ...
      <div className="flex flex-row justify-center items-center">
        <button className="btn btn-accent font-bold" type="button" onClick={() => calculate()}>
          See How Much
          <del className="text-gray-500">Mooched</del>
          {' '}
          Earned
        </button>
      </div>
